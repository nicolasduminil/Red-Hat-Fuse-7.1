...
@Service
@Command(scope = "customer-management", name = "findById", description = "Find customer by id")
public class FindByIdCommand implements Action
{
  @Reference
  ...
  {
    return customerManagementService.findCustomer(customerId);
  }
}
